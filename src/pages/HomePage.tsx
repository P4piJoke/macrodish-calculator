...
export default function HomePage() {
  ...
  return (
    <PageWrapper>
      <div className="flex flex-col items-center justify-center text-center py-12 md:py-24 gap-6 px-2">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-3 mt-2 w-full sm:w-auto">
          <Link
            to="/builder"
            className="w-full sm:w-auto bg-green-600 hover:bg-green-700 text-white font-semibold px-6 py-3 rounded-xl text-sm transition-colors text-center"
          >
            Start a recipe →
          </Link>
          <Link
            to="/recipes"
            className="w-full sm:w-auto bg-white border border-gray-300 hover:border-green-400 text-gray-700 font-semibold px-6 py-3 rounded-xl text-sm transition-colors text-center"
          >
